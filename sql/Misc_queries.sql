...
DESC TABLE CONTROL.FILE_INGEST_AUDIT;

SHOW SEQUENCES IN SCHEMA CONTROL;
...
select count(*) from RAW.LAND_REGISTRY_PRICE_PAID_BACKUP;
select count(*) from RAW.LAND_REGISTRY_PRICE_PAID;
