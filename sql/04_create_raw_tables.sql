...
CREATE TABLE IF NOT EXISTS LAND_REGISTRY_PRICE_PAID (
    ...
    _source_file VARCHAR
        COMMENT 'S3 object path of the source file from which the record was loaded.',
...
WHERE table_schema = 'RAW'
  AND table_name = 'LAND_REGISTRY_PRICE_PAID'
ORDER BY ordinal_position; -- List the columns of the LAND_REGISTRY_PRICE_PAID table to verify that it has been created successfully